...
const About = () => {
  return (
    <div className='h-fit font-poppins md:mt-24 '>
    <h1 className='text-white  text-3xl'>About Me</h1>
    <div className='flex flex-col text-white justify-center items-center  mt-10 gap-10 md:gap-20 md:flex-row '>
        {/* image */}
      <div className='w-fit'>
    ...
    {/* text  */}
    <div className='text-left text-lg px-1 md:w-[50%] mx-3'>
